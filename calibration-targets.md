...
Om du exporterar de kalibrerade bilderna i Chloros som vanlig JPG eller TIFF beräknas reflektansprocenten genom att dividera pixelvärdet med bitdjupet i bildformatet. För JPG dividerar du alltså med 255 och för TIFF dividerar du med 65 535. Du kan också välja PERCENT-formatet i Chloros, då kommer varje pixel att ha ett procentvärde mellan 0,0 och 1,0 (0 % till 100 % reflektans). Tänk bara på att vissa bildprogram inte kan hantera procentbilder (flyttal) och att de tar mycket lagringsutrymme.
