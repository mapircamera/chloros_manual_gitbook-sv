...
<figure><img src=".gitbook/assets/MAPIR Diffuse Reflectance Standard Calibration Target Data T4 (400-1000nm).png" alt=""><figcaption><p>MAPIR T4 Reflektans :: 400–1000 nm</p></figcaption></figure>Om du tittar på reflektansdiagrammet kan du se att värdena är våglängd (x-axeln) mot reflektansprocent (y-axeln). När vi tar en bild av kalibreringsmålet skapar vi sedan ett samband mellan pixelvärde och reflektansprocent, inom det spektrum som kamerans sensorbands är känsliga för.
